...
sparkVersion := sys.props.getOrElse("spark.version", "2.1.0-SNAPSHOT")
...
resolvers += "Hortonworks Maven Repository" at "http://nexus-private.hortonworks.com/nexus/content/groups/public"
